...
type (
	...
	YT struct {
		...
		Rich_metadata       []map[string]interface{} `json:"rich_metadata"`
		Super_titles        []map[string]interface{} `json:"super_titles"`
	...
	ConnEntry struct {
		...
		Rich_metadata       []map[string]interface{} `ch:"rich_metadata"`
		Super_titles        []map[string]interface{} `ch:"super_titles"`
